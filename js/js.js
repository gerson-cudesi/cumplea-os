...
function cambiar() {
    ...
    if (contador == 2) {
        ...
        document.getElementById('contador1').innerHTML = "<button id='id1' onclick='sonido.pause()' class='btn video' data-toggle='modal' data-target='#exampleModal' data-whatever='videos/vid-hannia.mp4' data-name='Hannia'></button>";
        ...
        document.getElementById('contador2').innerHTML = "<button id='id2' onclick='sonido.pause()' class='btn video' data-toggle='modal' data-target='#exampleModal' data-whatever='videos/vid-juan.mp4' data-name='Juan'></button>";
        $('#exampleModal').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var recipient = button.data('whatever')
            var name = button.data('name')
        ...
        document.getElementById('contador3').innerHTML = "<button id='id3' onclick='sonido.pause()' class='btn video' data-toggle='modal' data-target='#exampleModal' data-whatever='videos/vid-nery.mp4' data-name='Raidnerys'></button>";
        $('#exampleModal').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var recipient = button.data('whatever')
            var name = button.data('name')
        ...
        document.getElementById('contador4').innerHTML = "<button id='id4' onclick='sonido.pause()' class='btn video' data-toggle='modal' data-target='#exampleModal' data-whatever='videos/vid-yuli.mp4' data-name='Yuli' ></button>";
        $('#exampleModal').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var recipient = button.data('whatever')
            var name = button.data('name')
        ...
        document.getElementById('contador5').innerHTML = "<button id='id5' onclick='sonido.pause()' class='btn video ' data-toggle='modal' data-target='#exampleModal' data-whatever='videos/vid-yainni.mp4' data-name='Yainni' ></button>";
        $('#exampleModal').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var recipient = button.data('whatever')
            var name = button.data('name')
